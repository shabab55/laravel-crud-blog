        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Dashboard
                  <a href="" data-toggle="modal" data-target="#exampleModal" style="float:right" class="btn btn-danger btn-sm pull-right">Add New</a>
                  <a href="{{ route('news.add') }}" style="float:right;margin-right:10px" class="btn btn-danger btn-sm">News Add</a>
                </div>
